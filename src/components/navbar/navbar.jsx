    ...
    <nav className='h-40 bg-gray-200 sticky top-0 z-50 shadow-lg text-gray-800'>
      <div className="h-20 flex items-center justify-between">
        ...
        <ul className="mr-4 flex">        
          <li className=" max-w-[100vw] ml-4 bg-gray-200 hover:bg-gray-100 border border-gray-600 border-opacity-25 text-black py-2 px-2 lg:px-4 rounded active:border-gray-500">
