...
return(
        <>
            <div className={`m-4 p-4 w-[80vw] ${isToggle ? 'lg:w-[100%]' : 'lg:w-[50vw]' } bg-gray-300 rounded-lg flex justify-between`}>  
                ...
                <div className='min-w-[40%] lg:min-w-[132px] self-end'>
                    ...
                    <button onClick={() => deleteFromCart(product.id)} className='first:bg-gray-200 hover:bg-gray-100 border border-black border-opacity-25 text-black font-bold py-1 px-3 rounded  active:border-gray-500 hover:text-red-700'>
                        🗑
                    </button>
                </div>
            </div>
